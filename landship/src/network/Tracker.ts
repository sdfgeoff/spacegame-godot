import { MessageFromServer, MessageToServer, decodeMessageFromServer, encodeMessageToServer } from './TrackerMessages';
...
export type TrackerState = 'connecting' | 'connected' | 'disconnected' | 'error';
